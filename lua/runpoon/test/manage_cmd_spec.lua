...
describe("basic functionalities", function()
    ...
    before_each(function()
        emitted = false
        cmds = {}
        runpoon.get_term_config = function()
            return {
                cmds = cmds,
            }
        end
    ...
    it("add_cmd for empty", function()
        ...
        assert_table_equals(runpoon.get_term_config().cmds, expected_result)
    ...
    it("set_cmd_list", function()
        ...
        assert_table_equals(expected_result, runpoon.get_term_config().cmds)
    end)
end)
